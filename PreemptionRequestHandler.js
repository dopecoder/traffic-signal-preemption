...
var PreemptionRequestHandler = (function(){
    ...
    function Singleton(){
        ...
        this.api_keys = new Array(); // need to be initialized with actual some 10 keys lets say.
        this.request_key_list = new Array();
        this.request_list = new Array();


        this.api_keys.push('9b44dce7ba6862d8576a40525763a973');
        this.api_keys.push('fd79b6ea4158c81906e2828ba6c9f043');
        this.api_keys.push('0f908508c6b4d10d47f1d3366129769d');
        this.api_keys.push('0f908508c6b4d10d47f1d3366129769d');
        this.api_keys.push('17bfe8b41c162fb1d5f73fa97fb27b7f');
        this.api_keys.push('6d15dc381c0448546ee439441be97370');
    }
    ...
    Singleton.prototype.init_api_keys = function(api_keys){
        for(var api_key of api_keys){
            this.api_keys.push(api_key);
        }
    }

    Singleton.prototype.onAuthorize = function(api_key){
        for(var key of this.api_keys){
            if(key == api_key){
                ...
                var text = new Date();
                var key = MD5(text.toString());
                //generate a key and push it to this.request_key_list
                this.request_key_list.push(key);
